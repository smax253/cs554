...
const Home = () => {
    return (
        <div>
            <p>
                This is a simple example of using React to Query the TV Maze
                API. Start by clicking the "Shows" button above
            </p>
            ...
            <p className="hometext">
                ...
                <a
                    ...
                    target="_blank"
                    href="http://api.tvmaze.com/shows/page/0"
                >
                ...
                for searching the shows in the API (Where SEARCH_TERM is what
